...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="header" data-svelte-h="svelte-kfn815"><div class="header-container svelte-19b3zv1"><img src="./logo.png" alt="logo" class="logo svelte-19b3zv1"> <nav class="nav font-serif svelte-19b3zv1"><ul class="svelte-19b3zv1"><li class="svelte-19b3zv1"><a href="./">Home</a></li> <li class="svelte-19b3zv1"><a href="./about">About</a></li> <li class="svelte-19b3zv1"><a href="./contact">Contact</a></li></ul></nav></div> </header>`;
});
const css$1 = {
...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="footer font-serif svelte-a8bun7"><p data-svelte-h="svelte-a9vmb1">© EasyPath</p> <p>${escape(currentDateTime)}</p> </footer>`;
});
const css = {
  code: ".layout-wrapper.svelte-xlmn7p{display:flex;flex-direction:column;min-height:100vh;padding:1rem;max-width:1000px;margin:2rem auto;width:100%}.main-content.svelte-xlmn7p{flex-grow:1;padding:2rem;margin:2rem auto;max-width:1200px;width:100%}",
  map: `{"version":3,"file":"+layout.svelte","sources":["+layout.svelte"],"sourcesContent":["<script>\\n\\timport '../app.css';\\n\\timport Header from '$lib/Header.svelte';\\n\\timport Footer from '$lib/Footer.svelte';\\n<\/script>\\n\\n<div class=\\" layout-wrapper z-[-2]  bg-white bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]\\">\\n\\n\\t<!-- Header Component -->\\n\\t<Header />\\n\\n\\t<!-- Main Content Area -->\\n\\t<main class=\\"main-content\\">\\n\\t\\t<slot />\\n\\t</main>\\n\\n\\t<!-- Footer Component -->\\n\\t<Footer />\\n</div>\\n\\n<style>\\n\\t.layout-wrapper {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tmin-height: 100vh;\\n\\t\\tpadding: 1rem;\\n\\t\\tmax-width: 1000px;\\n\\t\\tmargin: 2rem auto;\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t\\n\\t.main-content {\\n\\t\\tflex-grow: 1;\\n\\t\\tpadding: 2rem;\\n\\t\\tmargin: 2rem auto;\\n\\t\\tmax-width: 1200px;\\n\\t\\twidth: 100%;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAqBC,6BAAgB,CACf,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,KAAK,CAAE,IACR,CAGA,2BAAc,CACb,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,CAAC,IAAI,CACjB,SAAS,CAAE,MAAM,CACjB,KAAK,CAAE,IACR"}`
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="layout-wrapper z-[-2] bg-white bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))] svelte-xlmn7p"> ${validate_component(Header, "Header").$$render($$result, {}, {}, {})}  <main class="main-content svelte-xlmn7p">${slots.default ? slots.default({}) : ``}</main>  ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})} </div>`;
});
export {
  Layout as default
};
